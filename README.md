...
1. Поготовка к защите проекта. Защита проекта, ответы на вопросы после выступления. 
2.Улучшить навыки воспроизвизведения видеороликов, презентаций, слайд-шоу, медиафайлов и другой итоговой продукции из исходных аудио, визуальных и мультимедийных компонентов средствами персонального компьютера и мультимедийного оборудования. 
3. Добавить ссылку на GitHub на главную страницу сайта.

### Пара №2. 10:05 - 10:50, 10:55 - 11:40
1. Анализ выступлений одногруппников. Сделать выводы по каждому из них.
2. Загрузить ссылку на сайт с созданием ментальных карт, чтобы при переходе по ней открывалась выполненная карта.

### Пара №3. 12:20 - 12:05, 13:10 - 13:55
1. Анализ выступлений одногруппников. Сделать выводы по каждому из них.
2. Сделать общие выводы по выступлениям и записать в дневник.
...
2. **Индивидуальное задание**: Конвертирование 3D-моделей в Blender с поддержкой материалов и текстур в формат Collada, DAE. Текстурная UV-карта. Доделать подробное описание шагов действий по выполнению задания на сайте.

### Пара №3. 12:20 - 12:05, 13:10 - 13:55
1.  Научиться создавать видеоролики, презентации, слайд-шоу, медиафайлы и другую итоговую
продукцию из исходных аудио, визуальных и мультимедийных компонентов.
2. Работа над презентацией к индивидуальному заданию.

### Пара №4. 14:05 - 14:50, 14:55 - 15:40
1. Оформление итогового отчета по практике.
2. Сделать отрендерить маяк и выгрузить в формате MP4.

# День 15/18 10.06.2024

### Пара №1. 08:20 - 09:05, 09:10 - 09:55
1. Воспроизвести подключение кабельной системы персонального компьютера, периферийного и
мультимедийного оборудования.
2. Провести занятия на клавиатурном тренажере с английской и русской раскладками.

### Пара №2. 10:05 - 10:50, 10:55 - 11:40
1. **Индивидуальное задание**: Конвертирование 3D-моделей в Blender с поддержкой материалов и текстур в формат Collada, DAE. Текстурная UV-карта. Дополнить сайт снимками и описаниями хода работы.
2. Воспроизвести конвертацию файлов с цифровой информацией в различные форматы.

### Пара №3. 15:50 - 16:35, 16:40 - 17:25
1. Добавить на сайт снимки занятий на клавиатурном тренажере.
2. Исправить ссылку, ведущую на отчеты по практике.
